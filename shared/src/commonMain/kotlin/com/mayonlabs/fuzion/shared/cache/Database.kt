...
internal class Database(databaseDriverFactory: DatabaseDriverFactory) {
    ...
    private val orderAdapter = com.mayonlabs.fuzion.shared.cache.OrderItem.Adapter(orderStatusAdapter, lineItemAdapter, kioskOrderAdapter)
    private val kioskAdapter = com.mayonlabs.fuzion.shared.cache.Kiosk.Adapter(menuAdapter)
    private val cartItemAdapter = com.mayonlabs.fuzion.shared.cache.CartItem.Adapter(addonOptionsStringAdapter, mixtureSettingsStringAdapter)
    private val favoritesItemAdapter = com.mayonlabs.fuzion.shared.cache.FavoritesItem.Adapter(imagesAdapter, variationsAdapter, addonOptionsAdapter, mixtureSettingsAdapter)
    private val menuItemAdapter = com.mayonlabs.fuzion.shared.cache.MenuItem.Adapter(imagesAdapter, variationsAdapter, addonOptionsAdapter, mixtureSettingsAdapter)
...
//    }
    ...
    fun createFavorites(item: com.mayonlabs.fuzion.shared.entity.FavoritesItem) {
        dbQuery.transaction {
            insertFavorite(item)
        }
    }

    private fun insertFavorite(item: com.mayonlabs.fuzion.shared.entity.FavoritesItem) {
